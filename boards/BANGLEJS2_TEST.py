...
# ----------------------------------------------------------------------------------------
#
# This version of the Bangle.js 2 firmware is a minimal build that's a bit faster
# to flash and boots straight into the test harness. It's only really useful
# for internal testing.

import pinutils;

info = {
 'name' : "Bangle.js 2 Test Firmware", # Using SMA Q3
 'boardname' : "BANGLEJS2",
...
# 'default_console_baudrate' : "9600",
 ...
 'bootloader' : 1,
 'binary_name' : 'espruino_%v_banglejs2_test.hex',
 'build' : {
   'optimizeflags' : '-Os',
   'libraries' : [
     'BLUETOOTH',
...
# ------------------------
     ...
     'JSMODULESOURCES += _:libs/js/banglejs/test.js',
