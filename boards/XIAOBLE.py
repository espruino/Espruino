...
def get_pins():
    pins = [
      ...
      { "name": "PD6", "sortingname": "D06", "port": "D", "num": "11", "functions": {} },
      { "name": "PD7", "sortingname": "D07", "port": "D", "num": "12", "functions": {} },
      { "name": "PD8", "sortingname": "D08", "port": "D", "num": "13", "functions": {} },
      { "name": "PD9", "sortingname": "D09", "port": "D", "num": "14", "functions": {} },
      { "name": "PD10", "sortingname": "D10", "port": "D", "num": "15", "functions": {} },
      { "name": "PD11", "sortingname": "D11", "port": "D", "num": "26", "functions": { "NEGATED": 0, "LED_RED": 0 } },
      { "name": "PD12", "sortingname": "D12", "port": "D", "num": "30", "functions": { "ADC1_IN6": 0, "NEGATED": 0, "LED_GREEN": 0 } },
      { "name": "PD13", "sortingname": "D13", "port": "D", "num": "6", "functions": { "NEGATED": 0, "LED_BLUE": 0 } },
      { "name": "PD14", "sortingname": "D14", "port": "D", "num": "9", "functions": { "NFC1": 0 } },
      { "name": "PD15", "sortingname": "D15", "port": "D", "num": "10", "functions": { "NFC2": 0 } },
      { "name": "PD16", "sortingname": "D16", "port": "D", "num": "17", "functions": { "NEGATED": 0, "CHG": 0 } },
      { "name": "PD17", "sortingname": "D17", "port": "D", "num": "13", "functions": { "HICHG": 0 } },
      { "name": "PD18", "sortingname": "D18", "port": "D", "num": "14", "functions": { "NEGATED": 0, "VBAT_ENABLE": 0 } },
      { "name": "PD19", "sortingname": "D19", "port": "D", "num": "31", "functions": { "ADC1_IN7": 0, "VBAT": 0 } },
      { "name": "PD20", "sortingname": "D20", "port": "D", "num": "25", "functions": { "QSPI_CS": 0 } },
      { "name": "PD21", "sortingname": "D21", "port": "D", "num": "21", "functions": { "QSPI_SCK": 0 } },
      { "name": "PD22", "sortingname": "D22", "port": "D", "num": "20", "functions": { "QSPI_MOSI": 0 } },
      { "name": "PD23", "sortingname": "D23", "port": "D", "num": "24", "functions": { "QSPI_MISO": 0 } },
      { "name": "PD24", "sortingname": "D24", "port": "D", "num": "22", "functions": { "QSPI_WP": 0 } },
      { "name": "PD25", "sortingname": "D25", "port": "D", "num": "23", "functions": { "QSPI_RST": 0 } },
      # mic and accelerometer are only present on the "sense" variant (Seeed XIAO BLE nRF52840 Sense)
      #{ "name": "PD26", "sortingname": "D26", "port": "D", "num": "10", "functions": { "MIC_PWR": 0 } },
      #{ "name": "PD27", "sortingname": "D27", "port": "D", "num": "0", "functions": { "MIC_PDM_CLK": 0 } },
      #{ "name": "PD28", "sortingname": "D28", "port": "D", "num": "16", "functions": { "MIC_PDM_DATA": 0 } },
      #{ "name": "PD29", "sortingname": "D29", "port": "D", "num": "8", "functions": { "6D_PWR": 0 } },
      #{ "name": "PD30", "sortingname": "D30", "port": "D", "num": "11", "functions": { "6D_INT1": 0 } },
      #{ "name": "PD31", "sortingname": "D31", "port": "D", "num": "07", "functions": { "6D_I2C_SDA": 0 } },
      #{ "name": "PD32", "sortingname": "D32", "port": "D", "num": "27", "functions": { "6D_I2C_SCL": 0 } },
    ]
    # D16 CHG
    # get charge state via digitalRead(D16)
    # HIGH: charging, LOW: not charging
    # D17 HICHG / PIN_CHARGING_CURRENT
    # battery charging current see https://wiki.seeedstudio.com/XIAO_BLE/#battery-charging-current
    # HIGH: 100mA, LOW: 50mA
    # D18 VBAT_ENABLE
    # enable battery voltage reading by digitalWrite(D18, true)
    # D19 VBAT
