...
#     'DEFINES += -DCONFIG_GPIO_AS_PINRESET', # Allow the reset pin to work
     ...
     'DEFINES += -DESPR_JSVAR_FLASH_BUFFER_SIZE=64', # The buffer size we use when executing/iterating over data in flash memory (default 32). Should be set based on benchmarks.     
