...
INCLUDE += -I$(ROOT)/targets/nrf5x/ble_cts_c
TARGETSOURCES += \
  ...
  $(ROOT)/targets/nrf5x/ble_cts_c/ble_cts_c.c \
...
$(PROJ_NAME).uf2: $(PROJ_NAME).hex
	@echo Creating UF2
	python3 scripts/uf2/uf2conv.py $(PROJ_NAME).hex -c -f 0xADA52840 -o $(PROJ_NAME).uf2
