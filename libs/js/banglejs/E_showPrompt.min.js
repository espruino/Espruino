...
e-12,b+c+4,e-8,b+c+4,e+8,b+c,e+12,b-c,e+12,b-c-4,e+8,b-c-4,e-8,b-c,e-12];h==a.selected&&(g.setColor(0,.5,1),g.fillPoly(c),g.setColor(1,1,1));g.drawPoly(c);g.drawString(d,b,e+1);b+=(16+f)/2});g.setColor(1,1,1);g.flip()}a||(a={});a.buttons||(a.buttons={Yes:!0,No:!1});var k=Object.keys(a.buttons);a.selected||(a.selected=0);Bangle.btnWatches&&(Bangle.btnWatches.forEach(clearWatch),Bangle.btnWatches=void 0);if(!l)return g.clear(1),g.flip(),Promise.resolve();h();return new Promise(function(d){Bangle.btnWatches=
