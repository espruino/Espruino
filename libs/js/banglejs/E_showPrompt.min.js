...
1);c+=(16+u)/2});Bangle.setLCDPower(1)}a||(a={});a.buttons||(a.buttons={Yes:!0,No:!1});var t=require("locale"),m=Object.keys(a.buttons);a.selected||(a.selected=0);g.reset().clearRect(Bangle.appRect);if(!v)return Bangle.setUI(),Promise.resolve();p();return new Promise(h=>{Bangle.setUI({mode:"leftright",remove:a.remove},e=>{0>e?0<a.selected&&(a.selected--,p()):0<e?a.selected<m.length-1&&(a.selected++,p()):(E.showPrompt(),h(a.buttons[m[a.selected]]))})})})