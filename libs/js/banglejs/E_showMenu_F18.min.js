...
c.fontHeight||(c.fontHeight=6);var q=Bangle.appRect,r=q.x,l=q.x2-11,n=q.y,t=q.y2-20;c.title&&(n+=c.fontHeight+2);var d={lastIdx:0,draw:function(b,a){var p=0|Math.min((t-n)/c.fontHeight,e.length),f=E.clip(c.selected-(p>>1),0,e.length-p);f!=d.lastIdx&&(b=void 0);d.lastIdx=f;var u=f+p<e.length,h=n;g.reset().setFont("6x8",2).setFontAlign(0,-1,0);c.predraw&&c.predraw(g);void 0===b&&c.title&&(g.drawString(c.title,(r+l)/2,n-c.fontHeight-2),g.drawLine(r,n-2,l,n-2));void 0!==b&&(f<b&&(h+=c.fontHeight*(b-f),
f=b),f+p>a&&(p=1+a-b));for(;p--;){a=e[f];b=k[a];var m=f==c.selected&&!d.selectEdit;g.setColor(m?g.theme.bgH:g.theme.bg);g.fillRect(r,h,l,h+c.fontHeight-1);g.setColor(m?g.theme.fgH:g.theme.fg);g.setFontAlign(-1,-1);g.drawString(a,r,h);"object"==typeof b&&(a=l,m=b.value,b.format&&(m=b.format(m)),d.selectEdit&&f==c.selected&&(a-=25,g.setColor(g.theme.bgH).fillRect(a-(g.stringWidth(m)+4),h,l,h+c.fontHeight-1),g.setColor(g.theme.fgH).drawImage("\f\u0005\u0081\x00 \u0007\x00\u00f9\u00f0\u000e\x00@",a,h+
(c.fontHeight-10)/2,{scale:2})),g.setFontAlign(1,-1),g.drawString(m,a-2,h));g.setColor(g.theme.fg);h+=c.fontHeight;f++}g.setFontAlign(-1,-1);g.drawImage("\b\b\u0001\u00108|\u00fe\u0010\u0010\u0010\u0010",l+2,40);g.drawImage("\b\b\u0001\u0010\u0010\u0010\u0010\u00fe|8\u0010",l+2,194);g.drawImage("\b\b\u0001\x00\b\f\u000e\u00ff\u000e\f\b",l+2,116);g.setColor(u?g.theme.fg:g.theme.bg).fillPoly([104,220,136,220,120,228]);g.flip()},select:function(){var b=k[e[c.selected]];if("function"==typeof b)b(d);else if("object"==
...
c.selected),Math.max(a,c.selected))}};d.draw();Bangle.setUI({mode:"updown",back:k["< Back"]},b=>{b?d.move(b):d.select()});return d}Bangle.setUI()})