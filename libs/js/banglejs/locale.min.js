...
if(b)return(" "+c).substr(-2)+":"+("0"+d).substr(-2);b="am";0==c?c=12:12<=c&&(12<c&&(c-=12),b="pm");return(" "+c).substr(-2)+":"+("0"+d).substr(-2)+"."+("0"+a.getSeconds()).substr(-2)+" "+b},dow:(a,b)=>"Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" ")[a.getDay()].substr(0,b?3:10),month:(a,b)=>"January February March April May June July August September October November December".split(" ")[a.getMonth()].substr(0,b?3:10),number:(a,b)=>{null==b&&(b=2);var c=a.toFixed(b),d=c|0;a=
0>a?1:0;b=(""+Math.abs(c-d).toFixed(b)).substr(2,b);d=""+d;c=d.length;for(var h="";(c-=3)>a;)h=","+d.substr(c,3)+h;return d.substr(0,c+3)+h+(b?"."+b:"")},currency:a=>{console.log("Warning: Currency information is deprecated");return"\xa3"+a.toFixed(2)},distance:(a,b)=>1E3>a?e(a,b)+"m":e(a/1E3,b)+"km",speed:(a,b)=>e(a/1.60934,b)+"mph",temp:(a,b)=>e(a,b)+"'C",meridian:(a,b)=>b||f()?12>=a.getHours()?"am":"pm":"",is12Hours:f}