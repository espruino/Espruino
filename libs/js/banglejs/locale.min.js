...
0>a?1:0;b=(""+Math.abs(c-d).toFixed(b)).substr(2,b);d=""+d;c=d.length;for(var h="";(c-=3)>a;)h=","+d.substr(c,3)+h;return d.substr(0,c+3)+h+(b?"."+b:"")},currency:a=>{console.log("Warning: Currency information is deprecated");return"\xa3"+a.toFixed(2)},distance:(a,b)=>1E3>a?e(a,b)+"m":e(a/1E3,b)+"km",speed:(a,b)=>e(a/1.60934,b)+"mph",temp:(a,b)=>e(a,b)+"'C",meridian:a=>f()?12>=a.getHours()?"am":"pm":"",is12Hours:f}