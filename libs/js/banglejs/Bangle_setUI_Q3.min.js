...
(a,d)=>{f();e(d)};else if("custom"==c)b.touch&&(Bangle.touchHandler=b.touch),b.drag&&(Bangle.dragHandler=b.drag,Bangle.on("drag",Bangle.dragHandler)),b.swipe&&(Bangle.swipeHandler=b.swipe,Bangle.on("swipe",Bangle.swipeHandler)),b.btn&&(Bangle.btnWatches=[setWatch(function(){b.btn(1)},BTN1,{repeat:1,edge:"falling"})]);else throw Error("Unknown UI mode");if(b.back){var m=(a,d)=>{36>d.y&&48>d.x&&(d.handled=!0,b.back())};Bangle.on("touch",m);if(Bangle.touchHandler){var n=Bangle.touchHandler;Bangle.touchHandler=
