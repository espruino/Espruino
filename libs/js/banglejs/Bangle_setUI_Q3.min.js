...
(a,d)=>{f();e(d)};else if("custom"==c||"clockcustom"==c)"clockcustom"==c&&Bangle.CLOCK=1,b.touch&&(Bangle.touchHandler=b.touch),b.drag&&(Bangle.dragHandler=b.drag,Bangle.on("drag",Bangle.dragHandler)),b.swipe&&(Bangle.swipeHandler=b.swipe,Bangle.on("swipe",Bangle.swipeHandler)),b.btn&&(Bangle.btnWatches=[setWatch(function(){b.btn(1)},BTN1,{repeat:1,edge:"falling"})]);else throw Error("Unknown UI mode");if(b.back){var m=(a,d)=>{36>d.y&&48>d.x&&(d.handled=!0,b.back())};Bangle.on("touch",m);if(Bangle.touchHandler){var n=Bangle.touchHandler;Bangle.touchHandler=
(a,d)=>{d.handled||n(a,d)};Bangle.on("touch",Bangle.touchHandler)}var p=setWatch(function(){b.back()},BTN1,{edge:"falling"});WIDGETS=Object.assign({back:{area:"tl",width:24,draw:a=>g.reset().setColor("#f00").drawImage(atob("GBiBAAAYAAH/gAf/4A//8B//+D///D///H/P/n+H/n8P/n4f/vwAP/wAP34f/n8P/n+H/n/P/j///D///B//+A//8Af/4AH/gAAYAA=="),a.x,a.y),remove:a=>{clearWatch(p);Bangle.removeListener("touch",m);a||g.reset().clearRect({x:WIDGETS.back.x,y:WIDGETS.back.y,w:24,h:24});delete WIDGETS.back;a||Bangle.drawWidgets()}}},
global.WIDGETS);l&&Bangle.drawWidgets()}else if(Bangle.touchHandler)Bangle.on("touch",Bangle.touchHandler)}})
