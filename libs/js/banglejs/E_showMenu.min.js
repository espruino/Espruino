(function(n){g.clear(1);g.flip();Bangle.drawWidgets();if(n){var q=g.getWidth()-9;g.getHeight();var f=Object.keys(n),a=n[""];a&&f.splice(f.indexOf(""),1);a instanceof Object||(a={});a.fontHeight=16;a.x=0;a.x2=q-2;a.y=24;a.y2=220;void 0===a.selected&&(a.selected=0);a.fontHeight||(a.fontHeight=6);var r=0|a.x,p=a.x2||g.getWidth()-1,m=0|a.y,u=a.y2||g.getHeight()-1;a.title&&(m+=a.fontHeight+2);var t=require("locale"),d={lastIdx:0,draw:function(b,c){var l=0|Math.min((u-m)/a.fontHeight,
f.length),e=E.clip(a.selected-(l>>1),0,f.length-l);e!=d.lastIdx&&(b=void 0);d.lastIdx=e;var h=m;g.reset().setFont("6x8",2).setFontAlign(0,-1,0);void 0===b&&a.title&&(g.drawString(a.title,(r+p)/2,m-a.fontHeight-2),g.drawLine(r,m-2,p,m-2));void 0!==b&&(e<b&&(h+=a.fontHeight*(b-e),e=b),e+l>c&&(l=1+c-b));for(;l--;){c=f[e];b=n[c];var k=e==a.selected&&!d.selectEdit;g.setColor(k?g.theme.bgH:g.theme.bg);g.fillRect(r,h,p,h+a.fontHeight-1);g.setColor(k?g.theme.fgH:g.theme.fg);g.setFontAlign(-1,-1);g.drawString(t.translate(c),
r,h);"object"==typeof b&&(c=p,k=b.value,b.format&&(k=b.format(k)),k=t.translate(""+k),d.selectEdit&&e==a.selected&&(c-=25,g.setColor(g.theme.bgH).fillRect(c-(g.stringWidth(k)+4),h,p,h+a.fontHeight-1),g.setColor(g.theme.fgH).drawImage("\f\u0005\u0081\x00 \u0007\x00\u00f9\u00f0\u000e\x00@",c,h+(a.fontHeight-10)/2,{scale:2})),g.setFontAlign(1,-1),g.drawString(k,c-2,h));g.setColor(g.theme.fg);h+=a.fontHeight;e++}g.setFontAlign(-1,-1);l=e<f.length;g.drawImage("\b\b\u0001\u00108|\u00fe\u0010\u0010\u0010\u0010",
