...
d[1]),a.substr(b+d[1]+1);g[e]+=a.substr(b+1,c);f.getData(d[1]-c,function(a){g[e]+=a});return""}function w(a,b){if(b)return a(b);f.cmd("AT+CWMODE="+n+"\r\n",1E3,function(b){"no change"!=b&&"OK"!=b&&"WIFI DISCONNECT"!=b?a("CWMODE failed: "+(b?b:"Timeout")):a(null)})}function p(a){var b=a[0];void 0===e[b]&&e[5]?e[b]="Accept":"Wait"==e[b]?e[b]=!0:f.cmd("AT+CIPCLOSE="+b+"\r\n",1E3,function(a){e[b]=void 0})}function q(a){e[a[0]]=""!=g[a[0]]?"DataClose":void 0}function u(a,b){var d=0==n;n|=a;d?("1v91"==
process.version?(x.reset(),r.setup(115200,{rx:A3,tx:A2})):r.setup(115200,{rx:A3,tx:A2,cts:x}),f=require("AT").connect(r),f.register("+IPD",D),f.registerLine("0,CONNECT",p),f.registerLine("1,CONNECT",p),f.registerLine("2,CONNECT",p),f.registerLine("3,CONNECT",p),f.registerLine("4,CONNECT",p),f.registerLine("0,CLOSED",q),f.registerLine("1,CLOSED",q),f.registerLine("2,CLOSED",q),f.registerLine("3,CLOSED",q),f.registerLine("4,CLOSED",q),f.registerLine("WIFI CONNECTED",function(){t!=k.CLIENT;exports.emit("associated")}),
f.registerLine("WIFI GOT IP",function(){exports.emit("connected")}),f.registerLine("WIFI DISCONNECTED",function(){t&=~k.CLIENT;exports.emit("disconnected")}),exports.at=f,require("NetworkJS").create(B),f.cmd("\r\nAT+RST\r\n",1E4,function m(a){if("ready"==a||"Ready."==a)setTimeout(function(){f.cmd("ATE0\r\n",1E3,function F(a){if("ATE0"==a)return F;"OK"==a?f.cmd("AT+CIPDINFO=1\r\n",1E3,function(a){if("OK"!=a)return b("CIPDINFO failed: "+(a?a:"Timeout"));f.cmd("AT+CIPMUX=1\r\n",1E3,function(a){if("OK"!=
a)return b("CIPMUX failed: "+(a?a:"Timeout"));f.cmd("AT+UART_CUR=115200,8,1,0,2\r\n",500,function(a){if("OK"!=a)return b("UART_CUR failed: "+(a?a:"Timeout"));w(b)})})}):b("ATE0 failed: "+(a?a:"Timeout"))})},500);else if(void 0===a)b("No 'ready' after AT+RST");else return m}),digitalWrite(G,1),digitalWrite(y,1)):w(b)}function C(a,b){b=b||function(){};(n&=~a)?w(b,null):(r.removeAllListeners(),f=void 0,exports.at=void 0,digitalWrite(y,0),e=[],setTimeout(b,1))}var G=A13,y=A14,x=A15,r=Serial2;digitalWrite(y,
0);var k={CLIENT:1,AP:2},H=["open","wep","wpa_psk","wpa2_psk","wpa_wpa2_psk"],n=0,t=0,f,e=[],v=[],g=["","","","",""],B={create:function(a,b,d){if(!f||!t)return-1;if(void 0===a&&2!=d)return c=5,e[c]="Wait",g[c]="",f.cmd("AT+CIPSERVER=1,"+b+"\r\n",1E4,function(a){"OK"==a?e[c]=!0:(e[c]=void 0,setTimeout(function(){throw Error("CIPSERVER failed ("+(a?a:"Timeout")+")");},0))}),5;for(var c=0;void 0!==e[c];)c++;if(5<=c)return-7;g[c]="";e[c]="Wait";var h;2==d?(b?h="AT+CIPSTART="+c+',"UDP","255.255.255.255",'+
