function z(a){return{ip:a.charCodeAt(0)+"."+a.charCodeAt(1)+"."+a.charCodeAt(2)+"."+a.charCodeAt(3),port:a.charCodeAt(5)<<8|a.charCodeAt(4),len:a.charCodeAt(7)<<8|a.charCodeAt(6)}}function D(a){var b=a.indexOf(":");if(0>b)return a;var d=a.substring(5,b).split(",");d[1]|=0;var c=a.length-(b+1),e=d[0];if(v[e]){var l=(d[2]||"0.0.0.0").split(".").map(function(a){return 0|a}),A=0|d[3];g[e]+=String.fromCharCode(l[0],l[1],l[2],l[3],A&255,A>>8,c&255,c>>8)}if(c>=d[1])return g[e]+=a.substr(b+1,
...
b+","+b+",2\r\n":e[c]="UDP",v[c]=!0):(h="AT+CIPSTART="+c+',"TCP",'+JSON.stringify(a)+","+b+"\r\n",delete v[c]);h&&f.cmd(h,1E4,function m(a){if("ALREADY CONNECTED"==a)return m;if("OK"!=a||!0!==e[c])e[c]=-6});return c},close:function(a){"Wait"==e[a]?e[a]="WaitClose":void 0!==e[a]&&(0>e[a]||"UDP"==e[a]?e[a]=void 0:f.cmd((5==a?"AT+CIPSERVER=0":"AT+CIPCLOSE="+a)+"\r\n",1E3,function(b){e[a]=void 0}))},accept:function(a){for(a=0;5>a;a++)if("Accept"==e[a])return e[a]=!0,a;return-1},recv:function(a,b,d){return g[a]?
...
a+","+b.length+h+"\r\n",2E3,function m(c){if("OK"!=c)if("> "==c)f.write(b);else if(c!="Recv "+b.length+" bytes"&&"busy s..."!=c){"SEND OK"==c?("WaitClose"==e[a]&&B.close(a),e[a]=!0):e[a]=void 0;return}return m});e[a]="Wait";return c}};exports.connect=function(a,b,d){var c="";d=d||function(){};void 0!==b.password&&(c=b.password);u(k.CLIENT,function(b){if(b)return d(b);f.cmd("AT+CWJAP="+JSON.stringify(a)+","+JSON.stringify(c)+"\r\n",2E4,function m(a){if(0<=["WIFI DISCONNECT","WIFI CONNECTED","WIFI GOT IP",
"+CWJAP:1"].indexOf(a))return m;"OK"!=a?setTimeout(d,0,"WiFi connect failed: "+(a?a:"Timeout")):setTimeout(d,0,null)})})};exports.disconnect=function(a){C(k.CLIENT,a)};exports.startAP=function(a,b,d){d=d||function(){};b=b||{};if(!b.password||8>b.password.length)throw Error("Password must be at least 8 characters");var c=b.password?"3":"0";if(b.authMode&&(c={open:0,wpa:2,wpa2:3,wpa_wpa2:4}[b.authMode],void 0===c))throw Error("Unknown authMode "+b.authMode);void 0===b.channel&&(b.channel=5);u(k.AP,
function(e){if(e)return d(e);f.cmd("AT+CWSAP="+JSON.stringify(a)+","+JSON.stringify(b.password)+","+b.channel+","+c+"\r\n",5E3,function(a){"OK"!=a?d("CWSAP failed: "+(a?a:"Timeout")):(n|=k.AP,d(null))})})};exports.stopAP=function(a){n&=~k.AP;C(k.AP,a)};exports.scan=function(a){var b=[];u(k.CLIENT,function(d){if(d)return a(d);f.cmdReg("AT+CWLAP\r\n",5E3,"+CWLAP:",function(a){a=a.slice(8,-1).split(",");b.push({ssid:JSON.parse(a[1]),authMode:H[a[0]],rssi:parseInt(a[2]),mac:JSON.parse(a[3]),channel:JSON.parse(a[4])})},
function(c){a(null,b)})})};exports.getIP=function(a){var b={};f.cmd("AT+CIFSR\r\n",1E3,function h(c){if(void 0===c)a("Timeout");else{if("+CIFSR:STAIP"==c.substr(0,12))b.ip=c.slice(14,-1);else if("+CIFSR:STAMAC"==c.substr(0,13))b.mac=c.slice(15,-1);else if("OK"==c){a(null,b);return}return h}})};exports.setIP=function(a,b){if("object"==typeof a&&a.ip){var d=[JSON.stringify(a.ip)];a.gw&&(d.push(JSON.stringify(a.gw)),d.push(JSON.stringify(a.netmask||"255.255.255.0")));d="AT+CIPSTA_CUR="+d.join(",")+"\r\n";
var c=3E3}else d="AT+CWDHCP_CUR=1,1\r\n",c=2E4;f.cmd(d,c,function(a){if("OK"==a)b(null);else return b("setIP failed: "+(a?a:"Timeout"))})};exports.getAPIP=function(a){var b={};f.cmd("AT+CIPAP_CUR?\r\n",1E3,function h(c){if(void 0===c)a("Timeout");else if("OK"==c)f.cmd("AT+CIPAPMAC_CUR?\r\n",1E3,function m(c){if(void 0===c)a("Timeout");else if("OK"==c)a(null,b);else return"+CIPAPMAC_CUR"==c.substr(0,14)&&(b.mac=JSON.parse(c.substr(10))),m});else return"+CIPAP_CUR"==c.substr(0,10)&&(c=c.split(":"),
"gateway"==c[1]&&"gw"==c[1],b[c[1]]=JSON.parse(c[2])),h})};exports.setAPIP=function(a,b){var d=[JSON.stringify(a.ip)];a.gw&&(d.push(JSON.stringify(a.gw)),d.push(JSON.stringify(a.netmask||"255.255.255.0")));f.cmd("AT+CIPAP_CUR="+d.join(",")+"\r\n",3E3,function(a){if("OK"==a)b(null);else return b("setAPIP failed: "+(a?a:"Timeout"))})};exports.setHostname=function(a,b){u(k.CLIENT,function(d){if(d)return b(d);f.cmd("AT+CWHOSTNAME="+JSON.stringify(a)+"\r\n",500,function(a){b("OK"==a?null:a)})})};exports.ping=
