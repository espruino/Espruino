...
node ../../../EspruinoDocs/bin/minify.js --pretokenise banglejs/E_showMenu_Bangle1.js banglejs/E_showMenu_Bangle1.min.js
node ../../../EspruinoDocs/bin/minify.js --pretokenise banglejs/E_showMenu_Bangle2.js banglejs/E_showMenu_Bangle2.min.js
...
node ../../../EspruinoDocs/bin/minify.js --pretokenise banglejs/E_showPrompt_Bangle2.js banglejs/E_showPrompt_Bangle2.min.js
...
node ../../../EspruinoDocs/bin/minify.js --pretokenise banglejs/E_showScroller_Bangle2.js banglejs/E_showScroller_Bangle2.min.js
...
node ../../../EspruinoDocs/bin/minify.js --pretokenise banglejs/Bangle_drawWidgets_Bangle2.js banglejs/Bangle_drawWidgets_Bangle2.min.js
...
node ../../../EspruinoDocs/bin/minify.js --pretokenise banglejs/Bangle_setUI_Bangle1.js banglejs/Bangle_setUI_Bangle1.min.js
node ../../../EspruinoDocs/bin/minify.js --pretokenise banglejs/Bangle_setUI_Bangle2.js banglejs/Bangle_setUI_Bangle2.min.js
node ../../../EspruinoDocs/bin/minify.js --pretokenise banglejs/Bangle_showRecoveryMenu_Bangle1.js banglejs/Bangle_showRecoveryMenu_Bangle1.min.js
