exports.list=function(b,d){var a=d[""],c=Object.keys(d);a&&c.splice(c.indexOf(""),1);a instanceof Object||(a={});void 0===a.selected&&(a.selected=0);a.fontHeight||(a.fontHeight=6);var f=0|a.x,h=a.x2||b.getWidth()-1,e=0|a.y,m=a.y2||b.getHeight()-1;a.title&&(e+=a.fontHeight+2);var l={draw:function(){b.clear();b.setColor(-1);a.predraw&&a.predraw();a.title&&(b.drawString(a.title,f+(h-f-b.stringWidth(a.title))/2,e-a.fontHeight-2),b.drawLine(f,e-2,h,e-2));for(var k=0|Math.min((m-e)/a.fontHeight,
