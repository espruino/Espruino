...
!0;Serial1.removeAllListeners();c&&setTimeout(c,10,Serial1)});else this.cellOn=!1,d.reset(),c&&setTimeout(c,1E3)};exports.setCharging=function(a){g.write(!a)};exports.setCharging=function(a){g.write(!a)};exports.setGPSOn=function(a,c){a?this.setCellOn(a,function(b){var a=require("AT").connect(b),d={at:a,on:function(b){b=b||function(){};a.cmd("AT+QGPS=4\r\n",1E3,function e(a){if(a.startsWith("AT+"))return e;b("OK"==a?null:a)})},off:function(b){b=b||function(){};a.cmd("AT+QGPSEND\r\n",1E3,function e(a){if(a.startsWith("AT+"))return e;
