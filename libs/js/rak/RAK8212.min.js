...
!0;Serial1.removeAllListeners();c&&setTimeout(c,10,Serial1)});else this.cellOn=!1,d.reset(),c&&setTimeout(c,1E3)};exports.setCharging=function(a){g.write(!a)};exports.setCharging=function(a){g.write(!a)};exports.setGPSOn=function(a,c){a?this.setCellOn(a,function(b){var a=require("AT").connect(b),d={at:a,on:function(b){b=b||function(){};a.cmd("AT+QGPS=1\r\n",1E3,function e(a){if(a&&a.startsWith("AT+"))return e;b("OK"==a?null:a)})},off:function(b){b=b||function(){};a.cmd("AT+QGPSEND\r\n",1E3,function e(a){if(a&&
a.startsWith("AT+"))return e;b("OK"==a?null:a)})},get:function(b){b=b||function(){};a.cmd("AT+QGPSLOC=2\r\n",1E3,function e(a){if(a){if(a.startsWith("AT+"))return e;if(a.startsWith("+CME ERROR:"))b({error:a.substr(5)});else if(a.startsWith("+QGPSLOC:")){a=a.substr(9).trim();var c=a.split(",");b({raw:a,UTC:c[0],lat:+c[1],lon:+c[2],alt:+c[4]})}else b({error:a})}else b({error:"Timeout"})})}};d.on(function(a){c(a,a?void 0:d)})}):this.setCellOn(!1,c)}