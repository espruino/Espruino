...
const unsigned char SPILCD_CMD_DATA = 0x2C;
#endif
#ifdef LCD_CONTROLLER_ST7796
static const unsigned char SPILCD_INIT_CODE[] = { // https://github.com/waveshareteam/ESP32-S3-Touch-LCD-3.5/blob/main/ESP-IDF/01_factory/components/esp_lcd_st7796/esp_lcd_st7796.c
   // CMD,DELAY,DATA_LEN,D0,D1,D2...
    0x11,120,0,
    0x36,0,1,  0x40, // memory access control 320x480
    0x3A,0,1,  0x05, // COLMOD
    0xF0,0,1,  0xC3, // command set
    0xF0,0,1,  0x96,
    0xB4,0,1,  0x01, // display inversion
    0xB7,0,1,  0xC6, // Entry Mode Set
    0xC0,0,2,  0x80, 0x45,
    0xC1,0,1,  0x13, // power control
    0xC2,0,1,  0xA7,
    0xC5,0,1,  0x0A, // VCOM
    0xE8,0,8,  0x40, 0x8A, 0x00, 0x00, 0x29, 0x19, 0xA5, 0x33,
    0xE0,0,14, 0xD0, 0x08, 0x0F, 0x06, 0x06, 0x33, 0x30, 0x33, 0x47, 0x17, 0x13, 0x13, 0x2B, 0x31,
    0xE1,0,14, 0xD0, 0x0A, 0x11, 0x0B, 0x09, 0x07, 0x2F, 0x33, 0x47, 0x38, 0x15, 0x16, 0x2C, 0x32,
    0xF0,0,1,  0x3C,
    0xF0,120,1,0x69,
    0x21,0,0,
    0x29,0,0,
