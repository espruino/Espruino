...
#if SPI_ENABLED
  /* FIXME: Use a handler when initing SPI which will make all transfers async -
   * then implement jshSPIWait (and we need to then ensure that the buffers we're given stay
   * around long enough). */
