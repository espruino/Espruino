...
#define NDEF_FLAGS_IL_MASK                  0x08 ///< Mask of ID field presence bit in NDEF record's flags byte.
#define NDEF_RECORD_PAYLOAD_LEN_LONG_SIZE   4    ///< Size of Payload Length field in long NDEF record.
