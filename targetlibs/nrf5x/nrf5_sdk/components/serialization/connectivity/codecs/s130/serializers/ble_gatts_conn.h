 ...
 *     @ref ble_gatts_value_get_rsp_enc for response encoding.
 *
 ...
 *
 * @sa @ref nrf51_gatts_value_get_sec_response for packet format.
 *     @ref ble_gatts_value_get_req_dec for request decoding.
 *
 ...
 *
 * @param[in]      return_code    Return code indicating if command was successful or not.
 * @param[in]      p_buff         Pointer to buffer where encoded data command response will be
 *                                returned.
 * @param[in, out] p_buff_len     \c in: size of \p p_buf buffer.
 *                                \c out: Length of encoded command response packet.
