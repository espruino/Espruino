                                              ...
                                              ble_gattc_handle_range_t * * const pp_handle_range)
{
    ...
    SER_ASSERT(op_code == SD_BLE_GATTC_ATTR_INFO_DISCOVER, NRF_ERROR_INVALID_PARAM);
...
{
    return ser_ble_cmd_rsp_status_code_enc(SD_BLE_GATTC_ATTR_INFO_DISCOVER, return_code, p_buf, p_buf_len);
}
