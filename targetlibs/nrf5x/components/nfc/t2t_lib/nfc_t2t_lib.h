#ifndef NFC_T2T_LIB_H
#define NFC_T2T_LIB_H
...
typedef enum
{
    NFC_T2T_EVENT_NONE,         ///< Not used.
    NFC_T2T_EVENT_FIELD_ON,     ///< NFC tag has detected external NFC field and was selected by an NFC polling device.
    NFC_T2T_EVENT_FIELD_OFF,    ///< External NFC field has been removed.
    NFC_T2T_EVENT_DATA_READ,    ///< NFC polling device has read all tag data. Repeated reading in the same session i.e. before @ref NFC_T2T_EVENT_FIELD_OFF event, will not trigger another @ref NFC_T2T_EVENT_DATA_READ event.
