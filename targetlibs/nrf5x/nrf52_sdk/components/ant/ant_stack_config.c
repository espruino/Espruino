...
static uint8_t ant_stack_bufer[ANT_BUFFER_SIZE_FOR_SD]; /*!< Memory buffer provided in order to support channel configuration */
...
uint32_t ant_stack_static_config(void)
{
    ANT_ENABLE m_ant_enable_cfg =
    {
        ...
        .pucMemoryBlockStartLocation    = ant_stack_bufer,
