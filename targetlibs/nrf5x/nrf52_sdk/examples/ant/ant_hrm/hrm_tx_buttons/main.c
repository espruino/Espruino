...
/**@file
 * @defgroup ant_hrm_tx_user_controlled_computed_heart_rate ANT HRM TX buttons
 * @{
 * @ingroup nrf_ant_hrm
 *
 * @brief Example of ANT HRM TX profile where the user can directly control the computed heart rate value using buttons.
 */
...
/**@brief Function for handling a UART error.
 *
...
{
#if defined(TRACE_UART)  
    // Configure and make the UART ready for use.  
