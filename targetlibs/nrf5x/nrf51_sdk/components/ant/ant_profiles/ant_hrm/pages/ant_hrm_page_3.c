...
static void page3_data_log(volatile ant_hrm_page3_data_t const * p_page_data)
{
...
{
    ant_hrm_page3_data_layout_t const * p_incoming_data = (ant_hrm_page3_data_layout_t *)p_page_buffer;
