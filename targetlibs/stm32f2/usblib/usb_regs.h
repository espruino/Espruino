...
{
  __IO USB_OTG_GREGS         *GREGS;
  __IO USB_OTG_DREGS         *DREGS;
  __IO USB_OTG_HREGS         *HREGS;
  __IO USB_OTG_INEPREGS      *INEP_REGS[USB_OTG_MAX_TX_FIFOS];
  __IO USB_OTG_OUTEPREGS     *OUTEP_REGS[USB_OTG_MAX_TX_FIFOS];
  __IO USB_OTG_HC_REGS       *HC_REGS[USB_OTG_MAX_TX_FIFOS];
  __IO uint32_t         *HPRT0;
