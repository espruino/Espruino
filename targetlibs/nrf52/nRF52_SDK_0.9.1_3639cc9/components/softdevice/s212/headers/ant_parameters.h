...
#define MESG_STACKLIMIT_ID                   ((uint8_t)0x55) ///< INTERNAL: ANT application - check softdevice + application stack usage
//...
...
#define MESG_SCALABLE_CHANNEL_CONFIG_ID      ((uint8_t)0x86) ///< INTERNAL: ANT application - scalable channel interface message ID
#define MESG_FLASH_PROTECTION_CHECK_ID       ((uint8_t)0xA7) ///< INTERNAL: ANT application - check flash protection message ID
#define MESG_BIST_ID                         ((uint8_t)0xAA) ///< INTERNAL: ANT application - built in self test message ID
#define MESG_SLEEP_ID                        ((uint8_t)0xC5) ///< INTERNAL: ANT application - sleep config message ID
#define MESG_CUSTOM_BLE_COMMAND              ((uint8_t)0xD0) ///< INTERNAL: ANT application - BLE control via ANT message interface
/** @} */
