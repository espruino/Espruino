...
/**
 * @ingroup  nrf_drivers
 * @addtogroup nrf_twis TWIS HAL and driver
 *
 * The TWIS HAL provides basic APIs for accessing the registers of the TWIS.
 ...
 *
 * This configuration is placed in global configuration file: @file nrf_drv_config.h.
 * @{
 */
...
typedef enum
{
    ...
    TWIS_EVT_STOP,         ///< Stop condition detected
...
/**
 * @brief TWIS slave event callback function type.
 *
