...
#ifdef NRF51
#define SPIS_IRQn SPI1_TWI1_IRQn
#define SPIS_IRQHandler SPI1_TWI1_IRQHandler
#elif defined (NRF52)
#define SPIS_IRQn SPIM1_SPIS1_TWIM1_TWIS1_SPI1_TWI1_IRQn
#define SPIS_IRQHandler SPIM1_SPIS1_TWIM1_TWIS1_SPI1_TWI1_IRQHandler
#endif
...
{    
    ...
    NVIC_SetPriority(SPIS_IRQn, SPI1_TWI1_IRQ_PRI);
