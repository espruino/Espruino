...
* `ESPR_JSVAR_FLASH_BUFFER_SIZE=64` - The buffer size in bytes we use when executing/iterating over data in external flash memory (default 32). Should be set based on benchmarks.
